...
public class Hqx_2x extends Hqx
{
	 ...
	 */
	public static void hq2x_32_rb(final int[] sp, final int[] dp, final int Xres, final int Yres)
	{
	 ...
	 */
	public static void hq2x_32_rb(final int[] sp, final int[] dp, final int Xres, final int Yres, int trY, int trU, final int trV, final int trA, final boolean wrapX, final boolean wrapY)
	{
		int spIdx = 0, dpIdx = 0;
